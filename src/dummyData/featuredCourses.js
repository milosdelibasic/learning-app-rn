export const featuredCourses = [
  {
    ...
    students: 120,
    rating: 4.5,
    type: ["frontend", "backend", "web", "game"],
    cardImage:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/480px-Unofficial_JavaScript_logo_2.svg.png",
    infoImage:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/480px-Unofficial_JavaScript_logo_2.svg.png",
    youtubeOverview: "DHjqpvDnNGE",
    about: `JavaScript (often shortened to JS) is a lightweight, interpreted, object-oriented language with first-class functions, and is best known as the scripting language for Web pages, but it's used in many non-browser environments as well. It is a prototype-based, multi-paradigm scripting language that is dynamic, and supports object-oriented, imperative, and functional programming styles.
...
JavaScript's dynamic capabilities include runtime object construction, variable parameter lists, function variables, dynamic script creation (via eval), object introspection (via for ... in), and source code recovery (JavaScript programs can decompile function bodies back into their source text).`,
  ...
  },
  {
    _id: "gfhrtd32",
    title: "Python",
    type: ["game", "backend", "machine"],
    students: 333,
    rating: 4.1,
    cardImage: "https://www.fintechnews.org/wp-content/uploads/2020/08/1-1.jpg",
    infoImage:
      "https://7yatak.net/wp-content/uploads/2021/04/How-to-Learn-Python.jpg",
    youtubeOverview: "x7X9w_GIm1s",
